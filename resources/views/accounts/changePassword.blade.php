          ...
          {{csrf_field()}}
              ...
              <div class="form-group col-md-offset-3 col-md-12 nxt-btn">
                @if(\Session::get('u_session')->type == 'individual')
  							<a href="{{url('/accounts/individual')}}" class="btn back-btn btn-lg"><i class="fa fa-arrow-circle-o-left pull-left" aria-hidden="true"></i> Back </a>
                  @elseif(\Session::get('u_session')->type == 'company')
                  <a href="{{url('/accounts/company')}}" class="btn back-btn btn-lg"><i class="fa fa-arrow-circle-o-left pull-left" aria-hidden="true"></i> Back </a>
                  @elseif(\Session::get('u_session')->type == 'shop')
                  <a href="{{url('/accounts/franchise')}}" class="btn back-btn btn-lg"><i class="fa fa-arrow-circle-o-left pull-left" aria-hidden="true"></i> Back </a>
                  @elseif(\Session::get('u_session')->type == 'serviceUser')
                  <a href="{{url('/accounts/hireService')}}" class="btn back-btn btn-lg"><i class="fa fa-arrow-circle-o-left pull-left" aria-hidden="true"></i> Back </a>
                  @endif
                <!-- <a href="#" class="btn finish-btn btn-lg">Finish <i class="fa fa-arrow-circle-o-right pull-right" aria-hidden="true"></i></a> -->
  				  			<button type="submit" id="pwd_btn"  class="btn save-btn btn-lg">Change <i class="fa fa-lock pull-right" aria-hidden="true"></i></button>
  				  		</div>
			        <!-- <div class="form-group">
